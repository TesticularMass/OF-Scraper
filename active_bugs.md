...
- **#53 `DownloadField.compare` cast (CLOSED 2026-05-02)** — `classes/table/fields/downloadfield.py:60` now casts `value = str(value)` before the membership checks, matching the sibling fix in `SelectField.compare` (#17, Batch 1). CLOSED.
