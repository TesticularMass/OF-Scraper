    ...
    def _run_scraper_thread(self):
        ...
        try:
            ...
            while True:
                ...
                # Import like module before the try block so _like_mod is
                # always defined when referenced in the post-scrape section.
                try:
                ...
                try:
                    _liked = dict(_like_mod._GUI_LIKE_TRACKER or {}) if _like_mod else {}
                    if _like_mod:
