...
---------------------------------------------------------------------------------------
current_price => [bold deep_sky_blue2]{settings.get_settings().current_price if settings.get_settings().current_price else 'paid and free'}[/bold deep_sky_blue2]
[Sub Price or Lowest Claimable Promo Price or Regular Price| See Final Price Details]
---------------------------------------------------------------------------------------
promo_price => [bold deep_sky_blue2]{settings.get_settings().promo_price if settings.get_settings().promo_price else 'paid and free'}[/bold deep_sky_blue2]
[Lowest Any Promo Price or Regular Price | See Final Price Details]
---------------------------------------------------------------------------------------
regular_price => [bold deep_sky_blue2]{settings.get_settings().regular_price if settings.get_settings().regular_price else 'paid and free'}[/bold deep_sky_blue2]
[Lowest Claimable Promo or Regular Price | See Final Price Details]
---------------------------------------------------------------------------------------
renewal_price => [bold deep_sky_blue2]{settings.get_settings().renewal_price if settings.get_settings().renewal_price else 'paid and free'}[/bold deep_sky_blue2]
...
sorting by =>  [bold deep_sky_blue2]{settings.get_settings().sort}[/bold deep_sky_blue2]
---------------------------------------------------------------------------------------
sorting direction => [bold deep_sky_blue2]{'desc' if settings.get_settings().desc else 'asc'}[/bold deep_sky_blue2]
========================================================================================================================================
PRESS ENTER TO RETURN
...
subscription => [bold deep_sky_blue2]{'active' if settings.get_settings().sub_status else 'expired' if settings.get_settings().sub_status is False else 'expired and active'}[/bold deep_sky_blue2]
---------------------------------------------------------------------------------------
renew => [bold deep_sky_blue2]{'renew on' if settings.get_settings().renewal else 'renew off' if settings.get_settings().renewal is False else 'renew on/off'}[/bold deep_sky_blue2]
==========================================================================================================================================
...
promo status => [bold deep_sky_blue2]{'promo on' if settings.get_settings().promo else 'promo off' if settings.get_settings().promo is False else 'promo off/on'}[/bold deep_sky_blue2]
---------------------------------------------------------------------------------------
all promo status => [bold deep_sky_blue2]{'all promo on' if settings.get_settings().all_promo else 'all promo off' if settings.get_settings().all_promo is False else 'all promo off/on'}[/bold deep_sky_blue2]
==========================================================================================================================================

last-seen => [bold deep_sky_blue2]{settings.get_settings().last_seen}[/bold deep_sky_blue2]
---------------------------------------------------------------------------------------
last-seen-before => [bold deep_sky_blue2]{settings.get_settings().last_seen_before}[/bold deep_sky_blue2]
---------------------------------------------------------------------------------------
last-seen-after => [bold deep_sky_blue2]{settings.get_settings().last_seen_after}[/bold deep_sky_blue2]
==========================================================================================================================================
